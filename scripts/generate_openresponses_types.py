...
Usage:
    python scripts/generate_openresponses_types.py [--force] [--check]
...
This file is generated by: scripts/generate_openresponses_types.py
Source: {spec_url}
Spec Hash: {spec_hash}

To regenerate:
    uv run python scripts/generate_openresponses_types.py --force
"""
...
def fix_discriminator_issues() -> None:
    ...
    # This handles cases like Field(discriminator="type") and Field(description="...", discriminator="type")
