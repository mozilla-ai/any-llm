...
class BaseOpenAIProvider(Provider, ABC):
    ...
    async def acompletion(self, params: CompletionParams, **kwargs) -> ChatCompletion | Iterator[ChatCompletionChunk]:
        client = AsyncOpenAI(
        ...
        return await self._convert_completion_response_async(response)
