...
def provider_reasoning_model_map() -> dict[LLMProvider, str]:
    return {
        ...
        LLMProvider.VERTEXAIANTHROMIC: "claude-sonnet-4-20250514",
...
def provider_model_map() -> dict[LLMProvider, str]:
    return {
        ...
        LLMProvider.VERTEXAIANTHROMIC: "claude-3-5-sonnet@20240620",
...
def provider_client_config() -> dict[LLMProvider, dict[str, Any]]:
    return {
        ...
        LLMProvider.VERTEXAIANTHROMIC: {"project_id": "test-project", "region": "us-central1"},
        LLMProvider.AZURE: {
